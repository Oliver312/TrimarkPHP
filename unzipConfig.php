...
$dir = '/home/ec2-user/Trimark/Inputs/Config';
...
for ($i = 2; $i < count($contents);$i++){
		...
		shell_exec('sudo unzip /home/ec2-user/Trimark/Inputs/Config/'.$vendor.' -d /home/ec2-user/Trimark/Inputs/RenamingFolder/');
			  
	    $dir2 = '/home/ec2-user/Trimark/Inputs/RenamingFolder/';
	    $contents2 = scandir($dir2);

	    for ($a = 2; $a < count($contents2);$a++){
		  $product = $contents2[$a];
		  $str2 = str_replace(".xml","",$product);
		  shell_exec('sudo mv /home/ec2-user/Trimark/Inputs/RenamingFolder/'.$product.' /home/ec2-user/Trimark/Inputs/ConfigExtract/'.$vendorName."_".$product);
	  } 
