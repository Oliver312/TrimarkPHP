...
$dir = '/home/ec2-user/Trimark/Inputs/ConfigExtract/3ed4e7a0-be0d-dd11-a23a-00304834a8c9';

$contents = scandir($dir);
//print_r($contents);
$vendorID = "3ed4e7a0-be0d-dd11-a23a-00304834a8c9";
...
//ListSelections
shell_exec('sudo find /home/ec2-user/Trimark/Inputs/Big2/TempConfig/ListSelections/ -name "*.csv" -exec cat "{}" ";" > /home/ec2-user/Trimark/Inputs/Big2/Merged/ListSelMerged.csv');
...
//ListProperties
shell_exec('sudo find /home/ec2-user/Trimark/Inputs/Big2/TempConfig/ListProperties/ -name "*.csv" -exec cat "{}" ";" > /home/ec2-user/Trimark/Inputs/Big2/Merged/ListPMerged.csv');
...
//RuleToList
shell_exec('sudo find /home/ec2-user/Trimark/Inputs/Big2/TempConfig/RuleToList/ -name "*.csv" -exec cat "{}" ";" > /home/ec2-user/Trimark/Inputs/Big2/Merged/RuleToListMerged.csv');
...
//RuleConditions
shell_exec('sudo find /home/ec2-user/Trimark/Inputs/Big2/TempConfig/RuleConditions/ -name "*.csv" -exec cat "{}" ";" > /home/ec2-user/Trimark/Inputs/Big2/Merged/RuleCondMerged.csv');
