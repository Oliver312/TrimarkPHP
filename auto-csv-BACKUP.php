...
//Executes Linux commands to run Mapforce Mappings
...
//Creates a .zip folder, named in "$zip->open". $zip->addFile represents all files in the .zip file
$zip = new ZipArchive();
$zip->open('/home/ec2-user/Trimark/Output/Perlick/Map_CSV.zip', ZipArchive::CREATE);
$zip->addFile('/home/ec2-user/Trimark/Output/Perlick/AddlItemData.csv','AddlItemData_Map.csv');
